...
cnt=0
hand_videos = ['/mnt/dms/KTW/hand4whole/results/json_sil3/json/귀엽다.npz','/mnt/dms/KTW/hand4whole/results/json_sil3/json/조상.npz' ]
# hand_videos = ['/mnt/dms/KTW/hand4whole/results/json_sil3/json/귀엽다.npz']
''' ### case 1
# final_mesh_info, ext = [],[]
...
for vi in tqdm(hand_videos, dynamic_ncols=True):
    vi = '/mnt/dms/KTW/data/npz/직접.npz'
