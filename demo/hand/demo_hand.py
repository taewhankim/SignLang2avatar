...
for ida, vid_list in enumerate(tqdm(videopath_list,dynamic_ncols=True)):
    ...
    try :
        for i, batch in enumerate(tqdm(testdata, dynamic_ncols=True)):
            ...
            mesh_info = {"frame_img_name" : batch['image_name']+'.jpg',
                         "image_size" : original_img.shape[:2],
                         "modify_image_size_in_mesh" : None,
                         "idx":i,
                         "mesh_info" : None}
            ...
            mesh_info['modify_image_size_in_mesh'] = cfg.output_image_size
            targets = {}
            meta_info = {}
            ## face prepro
            ...
            mesh_info['mesh_info'] = result_data2
            ...
            del result_data2
            gc.collect()
        # videonames[0][video_name] = batch['frame_cnt'][0]
        # make_json(os.path.join(mesh_info_dir, video_name+".json"), video_frame=videonames, mesh=anno_list)
