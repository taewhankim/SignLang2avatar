...
def add_handler_config(cfg):
    ...
    _C.MODEL.BACKBONE.CONTX_ATTN = CN()
    _C.MODEL.BACKBONE.CONTX_ATTN.WHERE = [0, 0, 2, 1]
    _C.MODEL.BACKBONE.CONTX_ATTN.INTER_CHANNELS = [128, 256, 512, 2048]  # Original number of channels
    _C.MODEL.BACKBONE.CONTX_ATTN.NUM_PARTS = 4
    _C.MODEL.BACKBONE.CONTX_ATTN.BN_LAYER = True