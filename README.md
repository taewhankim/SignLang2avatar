...
```
    ...
    hand_sign_ckpt_path = "/mnt/dms/KTW/hand_sqs/weights/output_5000epochs.ckpt"
...
```
python demo/hand/demo_hand.py --gpu 0 --inputpath /mnt/dms/KTW/hand4whole/gumsu --savefolder /mnt/dms/KTW/hand4whole/results/때2 --cont_n 10 "
```
