...
from models.synergynet.Sim3DR import RenderPipeline
...
def render(img, ver_lst, face_size, alpha=0.6, wfp=None, tex=None, connectivity=None):
    tri = sio.loadmat('/mnt/dms/KTW/synergynet/weights/3dmm_data/tri.mat')['tri'] - 1
    ...
    for ver_ in ver_lst:
        ...
        overlap = render_app(ver, tri, overlap, face_size,texture=tex)
